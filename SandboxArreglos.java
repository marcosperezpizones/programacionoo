...
public class SandboxArreglos
{
    ...
    public void eliminarEntero( int valor )
    {
        ...
        if (count == 0) return; // Valor no encontrado
    ...
    public void eliminarCadena( String cadena )
    {
        ...
        if (count == 0) return; // Cadena no encontrada
    ...
    public void reiniciarArregloEnteros( double[] valores )
    {
        ...
        for (int i = 0; i < valores.length; i++) {
            arregloEnteros[i] = (int) valores[i]; // Truncar el valor
        }
    }
    ...
    public void reiniciarArregloCadenas( Object[] objetos )
    {
    	 arregloCadenas = new String[objetos.length];
    	    for (int i = 0; i < objetos.length; i++) {
    	        arregloCadenas[i] = objetos[i].toString(); // Convertir a cadena
    	    }
    }
    ...
    {
        return java.util.Arrays.equals(arregloEnteros, otroArreglo);
    }
    ...
    public boolean mismosEnteros( int[] otroArreglo )
    {
        ...
        java.util.Arrays.sort(copiaOriginal);
        java.util.Arrays.sort(copiaOtro);
        
        return java.util.Arrays.equals(copiaOriginal, copiaOtro);
    }
